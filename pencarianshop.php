				...
				<?php foreach ($semua as $key => $value): ?>
						...
						<div class="col-md-3 d-flex">
							<div class="single-product" align="center">
								<img class="img-fluid" src="img/product/<?php echo $value['foto']; ?>" alt="">
								<div class="product-details" align="center">
									<h6><?php echo $value ['nama']; ?></h6>
									<div class="price">
										<h6>Rp. <?php echo number_format($value ['harga']) ; ?></h6>
									</div>
										<a href="beli.php?id_produk=<?php echo $pecah['id_produk'];?>" class="fa fa-shopping-cart" aria-hidden="true"></a>
										<a href="detail.php?id_produk=<?php echo $pecah['id_produk'];?>" class="btn">Detail</a>
								</div>
						   	</div>
						</div>
