		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="img/fav.png"></a>
				...
				<div class="col-lg-12">
					<div class="active-banner-slider owl-carousel">
						...
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>Casual Shoes</h1>
									<p>Selamat datang di Casual Shoes semua dijamin Original resmi kami tidak menjual barang kw.</p>
						...
						<div class="row single-slide">
							<div class="col-lg-5">
								<div class="banner-content">
									<h1>Casual New <br>Collection!</h1>
									<p>Selamat datang di Casual Shoes semua dijamin Original resmi kami tidak menjual barang kw.</p>
									<div class="add-bag d-flex align-items-center">
